# OpenRAM Configuration for L1 Instruction Cache
...
technology_name = "sky130"  # Change to "scn4m_subm" for generic or "freepdk45" for 45nm
...
# So total: 4 ways × 8 SRAMs/way = 32 SRAM instances for full L1 I-cache
word_size = 64           # 8 bytes = 64 bits (1/8 of cache line)
num_words = 128          # 128 cache lines per way
num_banks = 1            # Single bank for simplicity
